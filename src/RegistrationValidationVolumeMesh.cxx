...
namespace registration{
	...
	// constructor
	RegistrationValidationVolumeMesh::RegistrationValidationVolumeMesh(){
	}
	...
	// member function
	void RegistrationValidationVolumeMesh::Update(){
	...
	// MOVINGS //
		...
		for (int i=0; i<_movingMeshFileNames.size(); i++){
			...
			// load mesh
			std::cout << std::endl;
			std::cout << "mesh: " << i+1 << ": " << _movingMeshFileNames[i].ascii() << std::endl;
			...
			temp.remove(0, temp.lastIndexOf("/")+1);
			ImageHandler* imageHandler = new ImageHandler;
			for (int y=0; y<_movingMaskFileNames.size(); y++){
			...
			//std::cout << "cortical: distance: " << distance << " nOfRight: " << nOfRight << std::endl;
			...
			//std::cout << "trabecular: distance: " << distance << " nOfRight: " << nOfRight << std::endl;
			distance = 0.0; nOfRight = 0.0;
			...
			//std::cout << "marrow: distance: " << distance << " nOfRight: " << nOfRight << std::endl;
			distance = 0.0; nOfRight = 0.0;
	...
	void RegistrationValidationVolumeMesh::ReferenceLabels(vtkPolyData* mesh, ImageHandler::ImageType::Pointer image, 
	...
	void RegistrationValidationVolumeMesh::checkMovings(vtkIntArray* index, vtkPolyData* mesh, ImageHandler::ImageType::Pointer image, int part, double &distance, int &nOfRight){
