...
#ifndef REGISTATIONVALIDATIONVOLUME_H
#define REGISTATIONVALIDATIONVOLUME_H
...
namespace registration{
	...
	*/
	...
	class RegistrationValidationVolume{

	public:

		// constructor/destructor
		RegistrationValidationVolume();
		~RegistrationValidationVolume();
...
#endif //REGISTATIONVALIDATIONVOLUME_H